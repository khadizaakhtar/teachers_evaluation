            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    ...
                    <div class="box-content"> 
                      <form class="form-horizontal" action="<?php echo base_url(); ?>update_student/<?php echo $result->student_id; ?>" method="post">
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="hidden" name="student_id" value="<?php if (isset($result->student_id) != '') echo set_value('student_id', $result->student_id); ?>" class="span6 typeahead" id="typeahead"  data-provide="typeahead">
                                    </div>
                                </div>
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="batch_id">
                                            ...
                                            foreach ($all_batch as $v_batch) {
                                                ?> 
                                                <option value="<?php echo $v_batch->batch_id; ?>" <?php
                                                if (isset($result->batch_id) && $result->batch_id == $v_batch->batch_id) {
                                                    echo 'selected';
                                                }
                                                ?>><?php echo $v_batch->batch_name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    <button type="submit" name="btn" class="btn btn-primary">Update Student</button>
