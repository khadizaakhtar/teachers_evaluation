            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    ...
                    <div class="box-content"> 
                        <form class="form-horizontal" action="<?php echo base_url(); ?>save_sub_admin" method="post" enctype="multipart/form-data">
                            <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="email" name="email_address" class="span6 typeahead" id="typeahead"  data-provide="typeahead">
                                        <span style="color:red">*</span>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="password" name="password" class="span6 typeahead" id="typeahead"  data-provide="typeahead">
                                        <span style="color:red">*</span>
                                    </div>
                                </div>
