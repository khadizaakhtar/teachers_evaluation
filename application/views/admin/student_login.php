                ...
                <div class="row-fluid">
                    <div class="login-box">
                        <div class="icons">
                            ...
                            <a href="<?php echo base_url(); ?>teacher_login">Teacher</a> LogIn
                        </div>
                        <h2>Student LogIn | <a href="<?php echo base_url(); ?>sign_up">Sign Up</a></h2>
                        <?php
                        ...
                        <?php } ?>
                        <form class="form-horizontal" action="<?php echo base_url(); ?>student_login_check" method="post">
                            <fieldset>
                                <div class="input-prepend" title="student_id">
                                    <span class="add-on"><i class="halflings-icon user"></i></span>
                                    <input class="input-large span10 student_id" name="student_id" id="student_id" type="text" placeholder="type your Id"/>
                                </div>
                                ...
                                <div class="button-login">	
                                    <button type="submit" id="studentlogin" class="btn btn-primary">Login</button>
                                </div>
                                <div class="clearfix"></div>
                            </fieldset>
                        </form>	
