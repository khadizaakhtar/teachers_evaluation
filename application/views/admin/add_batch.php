            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    ...
                    <div class="box-content"> 
                        <form class="form-horizontal" action="<?php echo base_url(); ?>save_batch" method="post">
                            <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="batch_name" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" >
                                        <span style="color:red">*</span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group hidden-phone">
                                    ...
                                    <div class="controls">
                                        <textarea name="batch_description"  rows="3"></textarea>
                                    </div>
                                </div>
