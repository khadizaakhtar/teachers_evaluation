                ...
                <div class="row-fluid">
                    <div class="login-box">
                        <div class="icons">
                            ...
                            <a href="<?php echo base_url();?>student_login">Student</a> LogIn
                        </div>
                          <h2>Teacher LogIn</h2>
                          <?php
                    ...
                    <?php } ?>
                        <form class="form-horizontal" action="<?php echo base_url();?>teacher_login_check" method="post">
                            <fieldset>
                                <div class="input-prepend" title="teacher_id">
                                    <span class="add-on"><i class="halflings-icon user"></i></span>
                                    <input class="input-large span10 teacher_id" name="teacher_id" id="teacher_id" type="text" placeholder="type your Id"/>
                                </div>
