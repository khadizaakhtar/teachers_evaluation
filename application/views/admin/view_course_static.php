                            ...
                            <tbody>
                                ...
                                foreach ($all_course_static as $v_result) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="center"><?php echo $v_result->semester; ?> </td>
                                        <td><?php echo $v_result->name; ?></td>
                                        <?php 
                                        if(($this->session->userdata('access_level') == 1)){
                                        ?>
                                        <td class="center">
                                            ...
                                            <a class="btn btn-danger delete" title="delete this" href="<?php echo base_url(); ?>delete_course_static/<?php echo $v_result->course_assign_id; ?>" title="Delete" onclick="return check_delete_info();">
...
<script>
    $('body').delegate('.delete', 'click', function () {
        ...
        if (makeChange) {
            swal({
                title: "Are you sure?",
                text: "This course static will be deleted",
                type: "warning",
