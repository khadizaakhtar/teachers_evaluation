                        ...
                        <form class="form-horizontal" action="<?php echo base_url(); ?>save_course" method="post">
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="course_name" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" >
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="course_code" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" >
                                        <span style="color:red">*</span>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="course_credit" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" >
                                        <span style="color:red">*</span>
                                    </div>
                                </div>
                                <div class="control-group">
