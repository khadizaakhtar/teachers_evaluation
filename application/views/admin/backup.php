                        ...
                        <form class="form-horizontal" action="<?php echo base_url(); ?>save_course_assign_to_teacher" method="post" enctype="multipart/form-data">
                            <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="radio" name="punctual_teacher" value="3" >1
                                        <input type="radio" name="punctual_teacher" value="2"> 2
                                        <input type="radio" name="punctual_teacher" value="3"> 3
                                        <input type="radio" name="punctual_teacher" value="4"> 4
                                        <input type="radio" name="punctual_teacher" value="5"> 5
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="mar">4.Were you satisfied with your teacher's time management in the class ? </label>
                                    <div class="controls">
                                        <input type="radio" name="satisfied_of_teacher" value="1" >1
                                        <input type="radio" name="satisfied_of_teacher" value="2"> 2
                                        <input type="radio" name="satisfied_of_teacher" value="3"> 3
                                        <input type="radio" name="satisfied_of_teacher" value="4"> 4
                                        <input type="radio" name="satisfied_of_teacher" value="5"> 5
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <label class="mar">7.Did the teacher use English as the medium if instruction in the class ? </label>
                                    <div class="controls">
                                        <input type="radio" name="teacher_use_English" value="1" >1
                                        <input type="radio" name="teacher_use_English" value="2"> 2
                                        <input type="radio" name="teacher_use_English" value="3"> 3
                                        <input type="radio" name="teacher_use_English" value="4"> 4
                                        <input type="radio" name="teacher_use_English" value="5"> 5
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="mar">8.How much prumpiness your teacher cloud show while giving you feedback on your test or lesson ? </label>
                                    <div class="controls">
                                        <input type="radio" name="prumpiness_your_teacher" value="1" >1
                                        <input type="radio" name="prumpiness_your_teacher" value="2"> 2
                                        <input type="radio" name="prumpiness_your_teacher" value="3"> 3
                                        <input type="radio" name="prumpiness_your_teacher" value="4"> 4
                                        <input type="radio" name="prumpiness_your_teacher" value="5"> 5
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                 ...
                                 <div class="control-group">
                                    ...
                                    taken by the course teacher? </label>
                                     <div class="controls">
                                        <input type="text" name="teacher_rank">
