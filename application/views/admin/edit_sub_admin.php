            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    ...
                    <div class="box-content"> 
                        <form class="form-horizontal" action="<?php echo base_url(); ?>update_sub_admin/<?php echo $result->admin_id; ?>" method="post">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">Sub-Admin Name </label>
                                    <div class="controls">
                                        ...
                                        <input type="hidden" name="admin_id" value="<?php if (isset($result->admin_id) != '') echo set_value('admin_id', $result->admin_id); ?>" class="span6 typeahead" id="typeahead"  data-provide="typeahead">
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="fileInput">Sub-Admin Image</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <div class="form-actions">
                                            <button type="submit" name="btn" class="btn btn-primary">Update Sub-Admin</button>
